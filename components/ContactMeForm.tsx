...
export default function ContactMeForm() {
  return (
    <div className='w-full bg-[#1a1a1a]  flex flex-col gap-5 justify-between rounded-t-3xl   h-full '>
      ...
      <div className='w-full my-5 self-end justify-between flex px-10 lg:px-24 flex-row gap-10'>
        <div>
          <span className='text-sm opacity-50'> Socials:</span>
          <div className='flex  flex-col md:flex-row uppercase 2 lg:gap-5'>
        ...
        <div>
          <span className='text-sm opacity-50'>Designed & Developed By:</span>
          <div className='flex uppercase flex-wrap gap-10'>
            <AnimSmallText>Farhan Mansuri</AnimSmallText>
